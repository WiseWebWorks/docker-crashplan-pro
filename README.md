...
| **Application version** label | Displays the version of CrashPlan integrated into Docker image. |
...
Any desktop notification generated by CrashPlan is forwarded to the
